...
function Home() {
    ...
    if ($[0] !== "1427815ba6f5a71497b67da6e472972cff5bcdcf67f47f00ddfdf47445968ca3") {
        for(let $i = 0; $i < 3; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1427815ba6f5a71497b67da6e472972cff5bcdcf67f47f00ddfdf47445968ca3";
    }
    let t0;
...
function Game() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Game.useEffect": ()=>{
            if (game && (game.current_state === "w" || game.current_state === "W" || game.current_state === "won")) {
                setShowWin(true);
            }
        }
    }["Game.useEffect"], [
...
_s(Game, "FimZeDByBRTMU2R+ITfv/XaHAM8=");
_c = Game;
var _c;
...
function WinModal(t0) {
    ...
    if ($[0] !== "48eada0119dde4789275286bdc8ababef29c8525ded7958d4fe1f260d52256e2") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "48eada0119dde4789275286bdc8ababef29c8525ded7958d4fe1f260d52256e2";
    }
...
//# sourceMappingURL=_0xuluin._.js.map