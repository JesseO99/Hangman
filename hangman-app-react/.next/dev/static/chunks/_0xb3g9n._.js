...
function Home() {
    ...
    if ($[0] !== "7d4795e0fa570f5aec06fbb938f6d4bdc15a6182a9777e7c4914026932d648ff") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7d4795e0fa570f5aec06fbb938f6d4bdc15a6182a9777e7c4914026932d648ff";
    }
    let t0;
...
function GuessedWord(t0) {
    ...
    if ($[0] !== "cf97b620f8c09750b22a7ff5e59d1204d0604bd6942b424e935cdb3dd821ab37") {
        for(let $i = 0; $i < 13; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "cf97b620f8c09750b22a7ff5e59d1204d0604bd6942b424e935cdb3dd821ab37";
    }
    const { display: t1 } = t0;
...
function _GuessedWordCharsMap(ch, i) {
    const color = getContrastingTextColor("#fff");
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            minWidth: 32,
            height: 40,
...
function Key({ letter, status = "idle", onPress, disabled = false }) {
    ...
    // helper: compute contrasting text color (black or white) for readability
    function hexToRgb(hex) {
        const h = hex.replace('#', '');
        const bigint = parseInt(h.length === 3 ? h.split('').map((c)=>c + c).join('') : h, 16);
        return {
    ...
    function getContrastingTextColor(hex_0) {
        try {
            ...
            const lum = 0.2126 * R + 0.7152 * G + 0.0722 * B;
            // if luminance is dark, use white text
            return lum < 0.5 ? '#fff' : '#000';
        } catch (e) {
            return '#000';
        }
...
//# sourceMappingURL=_0xb3g9n._.js.map